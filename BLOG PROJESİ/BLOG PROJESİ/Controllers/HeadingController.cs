...
namespace BLOG_PROJESİ.Controllers
{
    public class HeadingController : Controller
    {
        ...
        public ActionResult AddHeading()
        {
            ...
            List<SelectListItem> valuewriter = (from x in wm.GetList() select new SelectListItem { Text = x.UserName + " " + x.WriterSurName, Value = x.WriterID.ToString() }).ToList();
            ViewBag.wrl = valuewriter;
            return View();
        }
        [HttpPost]
